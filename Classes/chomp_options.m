classdef chomp_options < handle
  ...
  properties
     ...
     fig = 1; %Whether to visualize or not during learning
     ex = 1; % what example image to display during training
     cells_per_image = 100; % a rough estimate of the average number of cells per image
     ...
     learn_decomp = 'HOSVD'; % HOSVD or MTF (MTF not implemented yet, %TODO - write R wrapper to use Kahn2015 code)


    % Extracting ROIs
     ROI_type = 'quantile_origsize';
     ROI_params = [0.9];
